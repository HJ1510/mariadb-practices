...
DROP TABLE IF EXISTS `bookmall`.`category` ;
...
-- Table `bookmall`.`book`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bookmall`.`book` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bookmall`.`member` ;
...
-- Table `bookmall`.`cart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bookmall`.`cart` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bookmall`.`orders` ;

CREATE TABLE IF NOT EXISTS `bookmall`.`orders` (
  `no` INT NOT NULL AUTO_INCREMENT,
  `orders_num` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `bookmall`.`order_book`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bookmall`.`order_book` ;

CREATE TABLE IF NOT EXISTS `bookmall`.`order_book` (
  `no` INT NOT NULL AUTO_INCREMENT,
  `orders_no` INT NOT NULL,
  `amount` INT NOT NULL,
  `book_no` INT NOT NULL,
  `orders_no` INT NOT NULL,
  PRIMARY KEY (`no`, `orders_no`),
  CONSTRAINT `fk_order_book_book1`
    FOREIGN KEY (`book_no`)
    REFERENCES `bookmall`.`book` (`no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
